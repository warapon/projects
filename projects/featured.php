                            ...
                            <ul>
                                ...
                                while ($row = mysql_fetch_array($result)) {
                                    ...
                                    <div class="col-sm-6 blog-main">
                                        <li><a href="?ft=<?=$row["ne_id"]?>&name=<?=$row["ne_name"]?>"><?=$row["ne_name"]?></a></li>
                                    </div>
                                    <?php
                                }
                                ?>
                ...
                <div class="panel panel-primary">
                    <div class="panel-body">
                        <div class="list-group">
                            <?php
//                            $query = "SELECT * FROM apartment WHERE nearby='".$_GET["ft"]."'";
                            $query = "SELECT *,AVG(review.`re_ score`) AS rating FROM apartment LEFT JOIN review ON apartment.ap_id = review.re_id_ap WHERE apartment.ap_status='อนุมัติแล้ว' AND nearby='".$_GET["ft"]."' GROUP BY apartment.ap_id ORDER BY apartment.ap_date DESC";
                            $result = mysql_query($query, $link);
